...
type VerificationService struct {
	...
	Phone   *VerificationPhoneService
}
...
func NewVerificationService(opts ...option.RequestOption) (r *VerificationService) {
	...
	r.Options = opts
	r.Phone = NewVerificationPhoneService(opts...)
	return
}
...
type VerificationNewParamsOptions struct {
	...
	ForceChallenge param.Field[bool] `json:"force_challenge"`
	...
	// account.
	MaxAutoFallbacks param.Field[int64] `json:"max_auto_fallbacks"`
