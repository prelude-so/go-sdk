...
```sh
go get -u 'github.com/prelude-so/go-sdk@v0.1.0-alpha.3'
```
...
`*prelude.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `prelude.FileParam(reader io.Reader, filename string, contentType string)`
